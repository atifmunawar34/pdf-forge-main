...
const QUICK_LINKS = [
  { toolId: 'merge', label: 'Merge & Split PDF' },
  { toolId: 'compress', label: 'Compress PDF' },
  { toolId: 'pdf-to-word', label: 'PDF to Word & Excel' },
  { toolId: 'organize', label: 'Visual Page Organizer' },
];
